        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><Link to="/shop?category=T-Shirts" className="text-gray-400 hover:text-white text-sm transition-colors">T-Shirts</Link></li>
              <li><Link to="/shop?category=Outerwear" className="text-gray-400 hover:text-white text-sm transition-colors">Outerwear</Link></li>
              <li><Link to="/shop?category=Accessories" className="text-gray-400 hover:text-white text-sm transition-colors">Accessories</Link></li>
            </ul>
          </div>
            ...
            <form className="flex flex-col space-y-2">
              <div className="relative">
                <input
                  ...
                  className="w-full bg-transparent border-b border-gray-600 px-0 py-2 text-sm text-white focus:outline-none focus:border-white transition-colors placeholder-gray-500"
                />
                <button
                  type="submit"
